...
void q_finished (tap_dance_state_t *state, void *user_data) {
  ...
  switch (qtap_state.state) {
    ...
    //case DOUBLE_HOLD: register_code(KC_LCTL);register_code(KC_Z);unregister_code(KC_Z); break;
    case DOUBLE_SINGLE_TAP: register_code(KC_Q);unregister_code(KC_Q);register_code(KC_Q); break;
  }
}
...
void w_finished (tap_dance_state_t *state, void *user_data) {
  ...
  switch (wtap_state.state) {
    ...
    case SINGLE_HOLD: register_code(KC_W); break;
...
void w_reset (tap_dance_state_t *state, void *user_data) {
  switch (wtap_state.state) {
    ...
    case SINGLE_HOLD: unregister_code(KC_W); break;
...
onetap_state.state = cur_dance(state);
switch (onetap_state.state) {
case SINGLE_TAP: register_code(KC_1); break;
case SINGLE_HOLD: register_code(KC_F12); break;
case DOUBLE_TAP: register_code(KC_LSFT);register_code(KC_1);unregister_code(KC_1); break;
case DOUBLE_HOLD: register_code(KC_LSFT);register_code(KC_1);unregister_code(KC_1); break;
case DOUBLE_SINGLE_TAP: register_code(KC_1);unregister_code(KC_1);register_code(KC_1); break;
  }
}
...
case DOUBLE_SINGLE_TAP: unregister_code(KC_1);
  }
onetap_state.state = 0;
}
...
twotap_state.state = cur_dance(state);
switch (twotap_state.state) {
case SINGLE_TAP: register_code(KC_2); break;
case SINGLE_HOLD: register_code(KC_F2); break;
case DOUBLE_TAP: register_code(KC_LSFT);register_code(KC_2);unregister_code(KC_2); break;
case DOUBLE_HOLD: register_code(KC_LSFT);register_code(KC_2);unregister_code(KC_2); break;
case DOUBLE_SINGLE_TAP: register_code(KC_2);unregister_code(KC_2);register_code(KC_2); break;
  }
}
...
case DOUBLE_TAP: unregister_code(KC_LSFT);break;
case DOUBLE_HOLD: unregister_code(KC_LSFT);break;
case DOUBLE_SINGLE_TAP: unregister_code(KC_2);
  }
twotap_state.state = 0;
}
...
eighttap_state.state = cur_dance(state);
switch (eighttap_state.state) {
case SINGLE_TAP: register_code(KC_8); break;
case SINGLE_HOLD: register_code(KC_F8); break;
case DOUBLE_TAP: register_code(KC_LSFT);register_code(KC_8);unregister_code(KC_8); break;
case DOUBLE_HOLD: register_code(KC_LSFT);register_code(KC_8);unregister_code(KC_8); break;
case DOUBLE_SINGLE_TAP: register_code(KC_8);unregister_code(KC_8);register_code(KC_8); break;
  }
}
...
case DOUBLE_TAP: unregister_code(KC_LSFT);break;
case DOUBLE_HOLD: unregister_code(KC_LSFT);break;
case DOUBLE_SINGLE_TAP: unregister_code(KC_8);
  }

  eighttap_state.state = 0;
}
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [CT_K_APOS] = ACTION_TAP_DANCE_TAP_HOLD(KC_Z, C(KC_Z)),
...
//    [CT_CTRL_CSTAB] = ACTION_TAP_DANCE_TAP_HOLD(S(C(KC_TAB)), KC_LCTL),
    ...
    */
    ...
    [QD_Q] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, q_finished, q_reset),
    [QD_W] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, w_finished, w_reset),    
    [QD_RCTL] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, rctl_finished, rctl_reset),
    [QD_1] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, one_finished, one_reset),
    [QD_2] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, two_finished, two_reset),
    [QD_8] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, eight_finished, eight_reset),
  */
};